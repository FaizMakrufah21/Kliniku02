...
import 'package:serverpod_auth_core_server/serverpod_auth_core_server.dart'
    as _i4;
import 'package:kliniku_server_server/src/generated/appointment.dart' as _i5;
import 'package:kliniku_server_server/src/generated/greetings/greeting.dart'
    as _i6;
import 'package:kliniku_server_server/src/generated/protocol.dart';
import 'package:kliniku_server_server/src/generated/endpoints.dart';
...
class TestEndpoints {
  ...
  late final _AdminSeedEndpoint adminSeed;

  late final _AppointmentEndpoint appointment;

  late final _SimpleAuthEndpoint simpleAuth;
...
class _InternalTestEndpoints extends TestEndpoints
  ...
  void initialize(
    ...
    simpleAuth = _SimpleAuthEndpoint(
      endpoints,
      serializationManager,
    );
  ...
  _i3.Future<List<String>> seedAdminAccounts(
    ...
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      var _localUniqueSession =
          (sessionBuilder as _i1.InternalTestSessionBuilder).internalBuild(
            endpoint: 'adminSeed',
            method: 'seedAdminAccounts',
          );
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'adminSeed',
          methodName: 'seedAdminAccounts',
          parameters: _i1.testObjectToJson({}),
          serializationManager: _serializationManager,
        );
        var _localReturnValue =
...
class _AppointmentEndpoint {
  ...
  _i3.Future<_i5.Appointment?> getAppointmentDetail(
    _i1.TestSessionBuilder sessionBuilder,
    int appointmentId,
  ) async {
    return _i1.callAwaitableFunctionAndHandleExceptions(() async {
      ...
      try {
        var _localCallContext = await _endpointDispatch.getMethodCallContext(
          createSessionCallback: (_) => _localUniqueSession,
          endpointPath: 'appointment',
          methodName: 'getAppointmentDetail',
